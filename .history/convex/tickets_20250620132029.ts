...
export const getUserTicketForEvent = query({
  ...
  handler: async (ctx, { eventId, userId }) => {
    ...
    // Filter tickets with relaxed criteria to support both paid and free tickets
...
// DEBUG QUERY: Temporarily removed due to server errors
// Will add back once we fix the underlying issue
