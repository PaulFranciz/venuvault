...
export default defineSchema({
  events: defineTable({
    ...
    locationType: v.optional(v.union(v.literal('physical'), v.literal('virtual'))),
    ...
    generalVideoStorageIds: v.optional(v.array(v.id("_storage"))),
    // Event details
    ...
    vendors: v.optional(v.array(v.object({
      name: v.string(),
      description: v.string(),
    }))),
