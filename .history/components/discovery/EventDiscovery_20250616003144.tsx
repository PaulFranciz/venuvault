...
export default function EventDiscovery({ userId }: EventDiscoveryProps) {
  ...
  // Fetch all events using the correct API
  const eventsResult = useQuery(api.eventDiscovery.searchEvents, {
  ...
  const events = eventsResult || { events: [], total: 0, hasMore: false };
