...
import { LayoutDashboard, CalendarDays, Ticket, BarChart2, MessageSquare, Users, Settings, X, Tag, Mail, Share2, UserPlus } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/seller/social-media', label: 'Social Media', icon: Share2 },
  { href: '/seller/affiliates', label: 'Affiliates & Referrals', icon: UserPlus },
