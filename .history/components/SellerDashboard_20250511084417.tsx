...
export default function SellerDashboard() {
  ...
  useEffect(() => {
    ...
    if (userProfile) {
        ...
        // Check if specific organizer profile fields (beyond just name) are filled
        ...
        if (userProfile.onboardingComplete) {
            ...
            setCurrentOnboardingStep("welcome");
        } else if (!organizerDetailsFilled) {
            // Name is present (not default), but no other organizer-specific details (logo, banner, socials) are filled.
            // This implies they haven't completed our OrganizerProfileForm with branding/socials.
            setCurrentOnboardingStep("profileForm");
        } else if (!paystackLinked) {
            // Name is present, organizer details are filled, but no Paystack.
            setCurrentOnboardingStep("paymentSetup");
        } else {
            // Name, organizer details, and Paystack are present, but onboardingComplete is false.
            // This is the case where we attempt to auto-complete.
    ...
    // console.warn("SellerDashboard: Unhandled state in main useEffect. Clerk Loaded: ", isClerkLoaded, " User ID: ", user?.id, " Convex Profile: ", userProfile);
    // setCurrentOnboardingStep("loading"); 
