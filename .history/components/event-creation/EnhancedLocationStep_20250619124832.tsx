...
const EnhancedLocationStep: React.FC<EnhancedLocationStepProps> = ({
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    // Reset verified status when address is changed manually (but not from Google Places)
    if (name === 'address') {
  ...
  // Handle Google Places address input changes
  const handleAddressInputChange = (value: string) => {
    setFormData({ address: value });
    // Reset verification when manually typing
