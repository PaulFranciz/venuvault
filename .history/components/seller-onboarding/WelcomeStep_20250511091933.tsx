        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div>
              <Button
                ...
                className="w-full sm:w-auto px-8 py-3 font-pally-medium text-base bg-brand-teal hover:bg-opacity-90 text-white rounded-lg transition-colors shadow-md hover:shadow-lg focus:ring-4 focus:ring-brand-teal focus:ring-opacity-50 disabled:opacity-50"
              >
                Let's Get Started
              </Button>
            </div>
          ...
          >
            ...
            <div className="text-center">
              <Rocket size={64} className="text-brand-teal mb-4 mx-auto" strokeWidth={1.5}/>
