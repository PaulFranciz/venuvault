...
const isPublicRoute = createRouteMatcher([
  ...
  '/api/admin/performance-metrics', // Performance monitoring endpoint (no auth needed for monitoring)
  '/api/admin/performance-dashboard', // Performance dashboard endpoint (no auth needed for monitoring)
