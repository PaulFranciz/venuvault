...
export default function EventPage() {
  ...
  const userTicket = useUserTicketsWithCache(params.id as string, user?.id || null);
  const queuePosition = useQueuePositionWithCache(params.id as string, user?.id || null);
