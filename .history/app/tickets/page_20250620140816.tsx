...
// Simple Ticket Card with click functionality to view full ticket
const SimpleTicketCard = ({ ticket }: { ticket: any }) => (
  <Link href={`/tickets/${ticket._id}`}>
    <div className="bg-white rounded-lg shadow-md p-6 border hover:shadow-lg transition-shadow cursor-pointer">
