...
export default function MyTicketsPage() {
  ...
  // Debug logging with more comprehensive information
  ...
  // Show consistent loading state during SSR and initial mounting
  if (!mounted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Loading your tickets...</h1>
  ...
  if (!isLoaded) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Verifying authentication...</h1>
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            We're still loading your tickets. This might take a moment.
          </p>
