  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Ticket Component - Only show if event exists */}
        {ticket.event && <Ticket ticketId={ticket._id} />}

        {/* Additional Information */}
        <div
          className={`mt-8 rounded-lg p-4 ${
            !ticket.event
              ? "bg-orange-50 border-orange-100 border"
              : ticket.event.is_cancelled
        ...
        >
          ...
          >
            {!ticket.event
              ? "For questions about missing events or refunds, please contact our support team at team@papareact-tickr.com"
              : ticket.event.is_cancelled
