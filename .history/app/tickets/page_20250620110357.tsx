...
export default function MyTicketsPage() {
  ...
  // Debug logging
  console.log("Tickets query result:", { tickets, user: user?.id, isSignedIn, isLoaded, mounted });

  // Always show loading during SSR and until mounted
  if (!mounted || !isLoaded) {
    return (
  ...
  // Only show "not authenticated" after everything is loaded and mounted
  if (!isSignedIn) {
    return (
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
