...
const DetailsStep: React.FC<DetailsStepProps> = ({
  ...
  // Simplified SectionCard component - no empty state buttons
    ...
    <div className="bg-[#1E1E1E] rounded-lg p-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          {icon}
          <div>
            <h4 className="font-pally-medium text-base text-white">
              {title} <span className="text-xs bg-[#2A2A2A] rounded-md px-2 py-1 text-gray-400 font-pally-regular">OPTIONAL</span>
            </h4>
            <p className="text-xs text-gray-400 font-pally-regular mt-0.5">{description}</p>
          </div>
        </div>
        <Switch
          checked={isEnabled}
  ...
  return (
    <div className="text-white">
      <h2 className="text-xl font-pally-medium mb-6">Content</h2>
      <div className="bg-[#1A1A1A] rounded-lg p-6">
        <h3 className="text-lg font-pally-bold border-b border-[#F96521]/30 pb-3 mb-6 text-white">Event Content</h3>
